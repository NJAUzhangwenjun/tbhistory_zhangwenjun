...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="/product/toMain.don"><i class="fa fa-dashboard"></i> 首页</a></li>
                <li><a href="#">数据管理</a></li>
                                ...
                                <div class="col-xs-12 table-responsive" >
                                    <table id="dataList"
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center sorting">CoordinateType</th>
                                            <th class="text-center sorting">数据记录时间</th>
                                            <th class="text-center sorting">是否为警告数据(0:不是,1:不是)</th>
                                        ...
                                        <c:forEach items="${list}" var="tbhistory">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">${tbhistory.isAlarmData }</td>
